...
class League():
    def __init__(self):
        ...
        self.player_3 = Player(name='Daniel', wins=8, losses=6, draws=0, points_for=12779, points_against=11914, scores=[852,911,900,879,884,771,999,1086,798,1019,909,871,892,1008,924,800])
        self.player_4 = Player(name='Henry', wins=8, losses=6, draws=0, points_for=11755, points_against=11700, scores=[879,916,767,764,783,834,838,796,782,778,1020,996,829,773,884])
        self.player_5 = Player(name='Jacob', wins=10, losses=4, draws=0, points_for=11786, points_against=11275, scores=[928,836,743,820,857,870,878,942,833,838,813,901,702,825,635,847])
        self.player_6 = Player(name='Jarrod', wins=10, losses=4, draws=0, points_for=11988, points_against=10983, scores=[681,979,891,870,773,828,862,838,851,857,942,975,952,689,966,761,806])
        ...
        self.player_9 = Player(name='Luke', wins=11, losses=3, draws=0, points_for=11992, points_against=11419, scores=[948,905,862,761,880,782,775,873,877,831,686,994,871,947,728,891,836])
        ...
        self.player_11 = Player(name='Nathan', wins=6, losses=8, draws=0, points_for=11736, points_against=11724, scores=[830,800,786,977,821,775,870,688,905,877,854,847,820,886,736])
        self.player_12 = Player(name='Ned', wins=7, losses=7, draws=0, points_for=11996, points_against=11829, scores=[660,889,816,760,831,895,815,943,972,682,877,820,1003,1033,903,1080,845])
        ...
        self.player_14 = Player(name='Noah', wins=9, losses=5, draws=0, points_for=12374, points_against=11945, scores=[814,952,826,840,931,981,772,769,787,945,864,978,1043,872,918,1059,910])
